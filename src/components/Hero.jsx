...
export default function Hero() {
  return (
    <div
      className="bg-cover w-full bg-center h-[100vh] flex flex-col  overflow-y-hidden"
      style={{ backgroundImage: "url('bg.png')" }}
    >
      <div className="relative  lg:top-[350px]  py-7 text-center items-center">
        <div className="w-[340px] h-8 py-2 tracking-normal  bg-amber-50/0 border-1 border-white rounded-full text-center text-white flex justify-end gap-6 items-center">
        ...
        <div className="w-[92vw] sm:h-[50%] lg:h-35  mt-6 ">
          <SearchBar />
        </div>
      </div>
    </div>
